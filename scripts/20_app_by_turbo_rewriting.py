...
from config import MOZILLA_PROJ, ECLIPSE_PROJ, OUTPUT_DIR, MOZILLA_SUMMARY_LEN, ECLIPSE_SUMMARY_LEN
...
if __name__ == "__main__":
    ...
    answers = app.process_by_turbo_rewriting(test_summary_pairs, prompt_type, foldername)
